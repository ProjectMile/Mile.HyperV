...
/* 202 */
enum _HV_REGISTER_NAME : __int32
{
  HvRegisterExplicitSuspend = 0x0,
  HvRegisterInterceptSuspend = 0x1,
  HvRegisterHypervisorVersion = 0x100,
  HvRegisterPrivilegesAndFeaturesInfo = 0x200,
  HvRegisterFeaturesInfo = 0x201,
  HvRegisterImplementationLimitsInfo = 0x202,
  HvRegisterHardwareFeaturesInfo = 0x203,
  HvRegisterCpuManagementFeaturesInfo = 0x204,
  HvRegisterSvmFeaturesInfo = 0x205,
  HvRegisterSkipLevelFeaturesInfo = 0x206,
  HvRegisterNestedVirtFeaturesInfo = 0x207,
  HvRegisterGuestCrashP0 = 0x210,
  HvRegisterGuestCrashP1 = 0x211,
  HvRegisterGuestCrashP2 = 0x212,
  HvRegisterGuestCrashP3 = 0x213,
  HvRegisterGuestCrashP4 = 0x214,
  HvRegisterGuestCrashCtl = 0x215,
  HvRegisterPowerStateConfigC1 = 0x220,
  HvRegisterPowerStateTriggerC1 = 0x221,
  HvRegisterPowerStateConfigC2 = 0x222,
  HvRegisterPowerStateTriggerC2 = 0x223,
  HvRegisterPowerStateConfigC3 = 0x224,
  HvRegisterPowerStateTriggerC3 = 0x225,
  HvRegisterSystemReset = 0x230,
  HvRegisterProcessorClockFrequency = 0x240,
  HvRegisterInterruptClockFrequency = 0x241,
  HvRegisterGuestIdle = 0x250,
  HvRegisterDebugDeviceOptions = 0x260,
  HvRegisterPendingInterruption = 0x10002,
  HvRegisterInterruptState = 0x10003,
  HvRegisterPendingEvent0 = 0x10004,
  HvRegisterPendingEvent1 = 0x10005,
  HvRegisterVpRuntime = 0x90000,
  HvRegisterGuestOsId = 0x90002,
  HvRegisterVpIndex = 0x90003,
  HvRegisterTimeRefCount = 0x90004,
  HvRegisterCpuManagementVersion = 0x90007,
  HvRegisterVpAssistPage = 0x90013,
  HvRegisterStatsPartitionRetail = 0x90020,
  HvRegisterStatsPartitionInternal = 0x90021,
  HvRegisterStatsVpRetail = 0x90022,
  HvRegisterStatsVpInternal = 0x90023,
  HvRegisterNestedVpIndex = 0x91003,
  HvRegisterSint0 = 0xA0000,
  HvRegisterSint1 = 0xA0001,
  HvRegisterSint2 = 0xA0002,
  HvRegisterSint3 = 0xA0003,
  HvRegisterSint4 = 0xA0004,
  HvRegisterSint5 = 0xA0005,
  HvRegisterSint6 = 0xA0006,
  HvRegisterSint7 = 0xA0007,
  HvRegisterSint8 = 0xA0008,
  HvRegisterSint9 = 0xA0009,
  HvRegisterSint10 = 0xA000A,
  HvRegisterSint11 = 0xA000B,
  HvRegisterSint12 = 0xA000C,
  HvRegisterSint13 = 0xA000D,
  HvRegisterSint14 = 0xA000E,
  HvRegisterSint15 = 0xA000F,
  HvRegisterScontrol = 0xA0010,
  HvRegisterSversion = 0xA0011,
  HvRegisterSifp = 0xA0012,
  HvRegisterSipp = 0xA0013,
  HvRegisterEom = 0xA0014,
  HvRegisterSirbp = 0xA0015,
  HvRegisterNestedSint0 = 0xA1000,
  HvRegisterNestedSint1 = 0xA1001,
  HvRegisterNestedSint2 = 0xA1002,
  HvRegisterNestedSint3 = 0xA1003,
  HvRegisterNestedSint4 = 0xA1004,
  HvRegisterNestedSint5 = 0xA1005,
  HvRegisterNestedSint6 = 0xA1006,
  HvRegisterNestedSint7 = 0xA1007,
  HvRegisterNestedSint8 = 0xA1008,
  HvRegisterNestedSint9 = 0xA1009,
  HvRegisterNestedSint10 = 0xA100A,
  HvRegisterNestedSint11 = 0xA100B,
  HvRegisterNestedSint12 = 0xA100C,
  HvRegisterNestedSint13 = 0xA100D,
  HvRegisterNestedSint14 = 0xA100E,
  HvRegisterNestedSint15 = 0xA100F,
  HvRegisterNestedScontrol = 0xA1010,
  HvRegisterNestedSversion = 0xA1011,
  HvRegisterNestedSifp = 0xA1012,
  HvRegisterNestedSipp = 0xA1013,
  HvRegisterNestedEom = 0xA1014,
  HvRegisterNestedSirbp = 0xA1015,
  HvRegisterStimer0Config = 0xB0000,
  HvRegisterStimer0Count = 0xB0001,
  HvRegisterStimer1Config = 0xB0002,
  HvRegisterStimer1Count = 0xB0003,
  HvRegisterStimer2Config = 0xB0004,
  HvRegisterStimer2Count = 0xB0005,
  HvRegisterStimer3Config = 0xB0006,
  HvRegisterStimer3Count = 0xB0007,
  HvRegisterVsmVpVtlControl = 0xD0000,
  HvRegisterVsmCodePageOffsets = 0xD0002,
  HvRegisterVsmVpStatus = 0xD0003,
  HvRegisterVsmPartitionStatus = 0xD0004,
  HvRegisterVsmVina = 0xD0005,
  HvRegisterVsmCapabilities = 0xD0006,
  HvRegisterVsmPartitionConfig = 0xD0007,
  HvRegisterVsmVpSecureConfigVtl0 = 0xD0010,
  HvRegisterVsmVpSecureConfigVtl1 = 0xD0011,
  HvRegisterVsmVpSecureConfigVtl2 = 0xD0012,
  HvRegisterVsmVpSecureConfigVtl3 = 0xD0013,
  HvRegisterVsmVpSecureConfigVtl4 = 0xD0014,
  HvRegisterVsmVpSecureConfigVtl5 = 0xD0015,
  HvRegisterVsmVpSecureConfigVtl6 = 0xD0016,
  HvRegisterVsmVpSecureConfigVtl7 = 0xD0017,
  HvRegisterVsmVpSecureConfigVtl8 = 0xD0018,
  HvRegisterVsmVpSecureConfigVtl9 = 0xD0019,
  HvRegisterVsmVpSecureConfigVtl10 = 0xD001A,
  HvRegisterVsmVpSecureConfigVtl11 = 0xD001B,
  HvRegisterVsmVpSecureConfigVtl12 = 0xD001C,
  HvRegisterVsmVpSecureConfigVtl13 = 0xD001D,
  HvRegisterVsmVpSecureConfigVtl14 = 0xD001E,
  HvX64RegisterRax = 0x20000,
  HvX64RegisterRcx = 0x20001,
  HvX64RegisterRdx = 0x20002,
  HvX64RegisterRbx = 0x20003,
  HvX64RegisterRsp = 0x20004,
  HvX64RegisterRbp = 0x20005,
  HvX64RegisterRsi = 0x20006,
  HvX64RegisterRdi = 0x20007,
  HvX64RegisterR8 = 0x20008,
  HvX64RegisterR9 = 0x20009,
  HvX64RegisterR10 = 0x2000A,
  HvX64RegisterR11 = 0x2000B,
  HvX64RegisterR12 = 0x2000C,
  HvX64RegisterR13 = 0x2000D,
  HvX64RegisterR14 = 0x2000E,
  HvX64RegisterR15 = 0x2000F,
  HvX64RegisterRip = 0x20010,
  HvX64RegisterRflags = 0x20011,
  HvX64RegisterXmm0 = 0x30000,
  HvX64RegisterXmm1 = 0x30001,
  HvX64RegisterXmm2 = 0x30002,
  HvX64RegisterXmm3 = 0x30003,
  HvX64RegisterXmm4 = 0x30004,
  HvX64RegisterXmm5 = 0x30005,
  HvX64RegisterXmm6 = 0x30006,
  HvX64RegisterXmm7 = 0x30007,
  HvX64RegisterXmm8 = 0x30008,
  HvX64RegisterXmm9 = 0x30009,
  HvX64RegisterXmm10 = 0x3000A,
  HvX64RegisterXmm11 = 0x3000B,
  HvX64RegisterXmm12 = 0x3000C,
  HvX64RegisterXmm13 = 0x3000D,
  HvX64RegisterXmm14 = 0x3000E,
  HvX64RegisterXmm15 = 0x3000F,
  HvX64RegisterFpMmx0 = 0x30010,
  HvX64RegisterFpMmx1 = 0x30011,
  HvX64RegisterFpMmx2 = 0x30012,
  HvX64RegisterFpMmx3 = 0x30013,
  HvX64RegisterFpMmx4 = 0x30014,
  HvX64RegisterFpMmx5 = 0x30015,
  HvX64RegisterFpMmx6 = 0x30016,
  HvX64RegisterFpMmx7 = 0x30017,
  HvX64RegisterFpControlStatus = 0x30018,
  HvX64RegisterXmmControlStatus = 0x30019,
  HvX64RegisterCr0 = 0x40000,
  HvX64RegisterCr2 = 0x40001,
  HvX64RegisterCr3 = 0x40002,
  HvX64RegisterCr4 = 0x40003,
  HvX64RegisterCr8 = 0x40004,
  HvX64RegisterXfem = 0x40005,
  HvX64RegisterIntermediateCr0 = 0x41000,
  HvX64RegisterIntermediateCr4 = 0x41003,
  HvX64RegisterIntermediateCr8 = 0x41004,
  HvX64RegisterDr0 = 0x50000,
  HvX64RegisterDr1 = 0x50001,
  HvX64RegisterDr2 = 0x50002,
  HvX64RegisterDr3 = 0x50003,
  HvX64RegisterDr6 = 0x50004,
  HvX64RegisterDr7 = 0x50005,
  HvX64RegisterEs = 0x60000,
  HvX64RegisterCs = 0x60001,
  HvX64RegisterSs = 0x60002,
  HvX64RegisterDs = 0x60003,
  HvX64RegisterFs = 0x60004,
  HvX64RegisterGs = 0x60005,
  HvX64RegisterLdtr = 0x60006,
  HvX64RegisterTr = 0x60007,
  HvX64RegisterIdtr = 0x70000,
  HvX64RegisterGdtr = 0x70001,
  HvX64RegisterTsc = 0x80000,
  HvX64RegisterEfer = 0x80001,
  HvX64RegisterKernelGsBase = 0x80002,
  HvX64RegisterApicBase = 0x80003,
  HvX64RegisterPat = 0x80004,
  HvX64RegisterSysenterCs = 0x80005,
  HvX64RegisterSysenterEip = 0x80006,
  HvX64RegisterSysenterEsp = 0x80007,
  HvX64RegisterStar = 0x80008,
  HvX64RegisterLstar = 0x80009,
  HvX64RegisterCstar = 0x8000A,
  HvX64RegisterSfmask = 0x8000B,
  HvX64RegisterInitialApicId = 0x8000C,
  HvX64RegisterMsrMtrrCap = 0x8000D,
  HvX64RegisterMsrMtrrDefType = 0x8000E,
  HvX64RegisterMsrMtrrPhysBase0 = 0x80010,
  HvX64RegisterMsrMtrrPhysBase1 = 0x80011,
  HvX64RegisterMsrMtrrPhysBase2 = 0x80012,
  HvX64RegisterMsrMtrrPhysBase3 = 0x80013,
  HvX64RegisterMsrMtrrPhysBase4 = 0x80014,
  HvX64RegisterMsrMtrrPhysBase5 = 0x80015,
  HvX64RegisterMsrMtrrPhysBase6 = 0x80016,
  HvX64RegisterMsrMtrrPhysBase7 = 0x80017,
  HvX64RegisterMsrMtrrPhysBase8 = 0x80018,
  HvX64RegisterMsrMtrrPhysBase9 = 0x80019,
  HvX64RegisterMsrMtrrPhysBaseA = 0x8001A,
  HvX64RegisterMsrMtrrPhysBaseB = 0x8001B,
  HvX64RegisterMsrMtrrPhysBaseC = 0x8001C,
  HvX64RegisterMsrMtrrPhysBaseD = 0x8001D,
  HvX64RegisterMsrMtrrPhysBaseE = 0x8001E,
  HvX64RegisterMsrMtrrPhysBaseF = 0x8001F,
  HvX64RegisterMsrMtrrPhysMask0 = 0x80040,
  HvX64RegisterMsrMtrrPhysMask1 = 0x80041,
  HvX64RegisterMsrMtrrPhysMask2 = 0x80042,
  HvX64RegisterMsrMtrrPhysMask3 = 0x80043,
  HvX64RegisterMsrMtrrPhysMask4 = 0x80044,
  HvX64RegisterMsrMtrrPhysMask5 = 0x80045,
  HvX64RegisterMsrMtrrPhysMask6 = 0x80046,
  HvX64RegisterMsrMtrrPhysMask7 = 0x80047,
  HvX64RegisterMsrMtrrPhysMask8 = 0x80048,
  HvX64RegisterMsrMtrrPhysMask9 = 0x80049,
  HvX64RegisterMsrMtrrPhysMaskA = 0x8004A,
  HvX64RegisterMsrMtrrPhysMaskB = 0x8004B,
  HvX64RegisterMsrMtrrPhysMaskC = 0x8004C,
  HvX64RegisterMsrMtrrPhysMaskD = 0x8004D,
  HvX64RegisterMsrMtrrPhysMaskE = 0x8004E,
  HvX64RegisterMsrMtrrPhysMaskF = 0x8004F,
  HvX64RegisterMsrMtrrFix64k00000 = 0x80070,
  HvX64RegisterMsrMtrrFix16k80000 = 0x80071,
  HvX64RegisterMsrMtrrFix16kA0000 = 0x80072,
  HvX64RegisterMsrMtrrFix4kC0000 = 0x80073,
  HvX64RegisterMsrMtrrFix4kC8000 = 0x80074,
  HvX64RegisterMsrMtrrFix4kD0000 = 0x80075,
  HvX64RegisterMsrMtrrFix4kD8000 = 0x80076,
  HvX64RegisterMsrMtrrFix4kE0000 = 0x80077,
  HvX64RegisterMsrMtrrFix4kE8000 = 0x80078,
  HvX64RegisterMsrMtrrFix4kF0000 = 0x80079,
  HvX64RegisterMsrMtrrFix4kF8000 = 0x8007A,
  HvX64RegisterTscAux = 0x8007B,
  HvX64RegisterMsrIa32MiscEnable = 0x800A0,
  HvX64RegisterIa32FeatureControl = 0x800A1,
  HvX64RegisterIa32VmxBasic = 0x800A2,
  HvX64RegisterIa32VmxPinbasedCtls = 0x800A3,
  HvX64RegisterIa32VmxProcbasedCtls = 0x800A4,
  HvX64RegisterIa32VmxExitCtls = 0x800A5,
  HvX64RegisterIa32VmxEntryCtls = 0x800A6,
  HvX64RegisterIa32VmxMisc = 0x800A7,
  HvX64RegisterIa32VmxCr0Fixed0 = 0x800A8,
  HvX64RegisterIa32VmxCr0Fixed1 = 0x800A9,
  HvX64RegisterIa32VmxCr4Fixed0 = 0x800AA,
  HvX64RegisterIa32VmxCr4Fixed1 = 0x800AB,
  HvX64RegisterIa32VmxVmcsEnum = 0x800AC,
  HvX64RegisterIa32VmxProcbasedCtls2 = 0x800AD,
  HvX64RegisterIa32VmxEptVpidCap = 0x800AE,
  HvX64RegisterIa32VmxTruePinbasedCtls = 0x800AF,
  HvX64RegisterIa32VmxTrueProcbasedCtls = 0x800B0,
  HvX64RegisterIa32VmxTrueExitCtls = 0x800B1,
  HvX64RegisterIa32VmxTrueEntryCtls = 0x800B2,
  HvX64RegisterVpRuntime = 0x90000,
  HvX64RegisterHypercall = 0x90001,
  HvX64RegisterEoi = 0x90010,
  HvX64RegisterIcr = 0x90011,
  HvX64RegisterTpr = 0x90012,
  HvX64RegisterYmm0Low = 0xC0000,
  HvX64RegisterYmm1Low = 0xC0001,
  HvX64RegisterYmm2Low = 0xC0002,
  HvX64RegisterYmm3Low = 0xC0003,
  HvX64RegisterYmm4Low = 0xC0004,
  HvX64RegisterYmm5Low = 0xC0005,
  HvX64RegisterYmm6Low = 0xC0006,
  HvX64RegisterYmm7Low = 0xC0007,
  HvX64RegisterYmm8Low = 0xC0008,
  HvX64RegisterYmm9Low = 0xC0009,
  HvX64RegisterYmm10Low = 0xC000A,
  HvX64RegisterYmm11Low = 0xC000B,
  HvX64RegisterYmm12Low = 0xC000C,
  HvX64RegisterYmm13Low = 0xC000D,
  HvX64RegisterYmm14Low = 0xC000E,
  HvX64RegisterYmm15Low = 0xC000F,
  HvX64RegisterYmm0High = 0xC0010,
  HvX64RegisterYmm1High = 0xC0011,
  HvX64RegisterYmm2High = 0xC0012,
  HvX64RegisterYmm3High = 0xC0013,
  HvX64RegisterYmm4High = 0xC0014,
  HvX64RegisterYmm5High = 0xC0015,
  HvX64RegisterYmm6High = 0xC0016,
  HvX64RegisterYmm7High = 0xC0017,
  HvX64RegisterYmm8High = 0xC0018,
  HvX64RegisterYmm9High = 0xC0019,
  HvX64RegisterYmm10High = 0xC001A,
  HvX64RegisterYmm11High = 0xC001B,
  HvX64RegisterYmm12High = 0xC001C,
  HvX64RegisterYmm13High = 0xC001D,
  HvX64RegisterYmm14High = 0xC001E,
  HvX64RegisterYmm15High = 0xC001F,
  HvX64RegisterCrInterceptControl = 0xE0000,
  HvX64RegisterCrInterceptCr0Mask = 0xE0001,
  HvX64RegisterCrInterceptCr4Mask = 0xE0002,
  HvX64RegisterCrInterceptIa32MiscEnableMask = 0xE0003,
};
...
/* 267 */
enum _HV_X64_PENDING_INTERRUPTION_TYPE : __int32
{
  HvX64PendingInterrupt = 0x0,
  HvX64PendingNmi = 0x2,
  HvX64PendingException = 0x3,
  HvX64PendingSoftwareInterrupt = 0x4,
  HvX64PendingPrivilegedSoftwareException = 0x5,
  HvX64PendingSoftwareException = 0x6,
};
...
/* 633 */
enum _HV_GENERIC_SET_FORMAT : __int32
{
  HvGenericSetSparse4k = 0x0,
  HvGenericSetAll = 0x1,
  HvGenericSetInvalid = 0x2,
};
...
/* 2778 */
struct $F8A197D8E7F6217FD5CDA51199CC9D7E
{
  unsigned __int8 TargetVtl : 4;
  unsigned __int8 UseTargetVtl : 1;
...
union _HV_INPUT_VTL
{
  ...
  $F8A197D8E7F6217FD5CDA51199CC9D7E __s1;
};
...
/* 2806 */
struct _HV_REGISTER_ASSOC
{
  _HV_REGISTER_NAME Name;
  unsigned int Pad;
  __declspec(align(16)) _HV_REGISTER_VALUE Value;
};

/* 2807 */
struct _HV_INPUT_SET_VP_REGISTERS
{
  unsigned __int64 PartitionId;
  unsigned int VpIndex;
  _HV_INPUT_VTL InputVtl;
  unsigned __int8 RsvdZ8;
  unsigned __int16 RsvdZ16;
  _HV_REGISTER_ASSOC Elements[];
};
...
/* 3011 */
struct _HV_INPUT_SEND_SYNTHETIC_CLUSTER_IPI
{
  unsigned int Vector;
  _HV_INPUT_VTL TargetVtl;
  unsigned __int8 RsvdZ0;
  unsigned __int16 RsvdZ1;
...
{
  unsigned __int64 AddressSpace;
  unsigned __int64 Flags;
  unsigned __int64 ProcessorMask;
};

/* 3224 */
struct _HV_INPUT_RETRIEVE_DEBUG_DATA
{
  unsigned int Count;
  unsigned int Options;
...
/* 3376 */
struct _HV_INPUT_ENABLE_VP_VTL
{
  unsigned __int64 PartitionId;
  unsigned int VpIndex;
  ...
  _HV_INITIAL_VP_CONTEXT VpVtlContext;
};

/* 3407 */
struct _HV_INPUT_FLUSH_VIRTUAL_ADDRESS_SPACE
{
  _HV_INPUT_FLUSH_VIRTUAL_ADDRESS_SPACE_HEADER Header;
};
...
/* 3602 */
struct $13D83AE328EB4A3C9543C3D1EB5D1A27
{
  unsigned __int64 Protectable : 1;
  unsigned __int64 Reserved : 63;
};

/* 3603 */
union _HV_GPA_PAGE_ATTRIBUTES
{
  unsigned __int64 AsUINT64;
  $13D83AE328EB4A3C9543C3D1EB5D1A27 __s1;
};

/* 3604 */
struct _HV_INPUT_SET_GPA_PAGE_ATTRIBUTES
{
  unsigned __int64 PartitionId;
  _HV_GPA_PAGE_ATTRIBUTES Attributes;
...
/* 3669 */
struct _HV_INPUT_ENABLE_PARTITION_VTL
{
  unsigned __int64 PartitionId;
  unsigned __int8 TargetVtl;
  _HV_ENABLE_PARTITION_VTL_FLAGS Flags;
  unsigned __int16 ReservedZ0;
  unsigned int ReservedZ1;
};
...
/* 3704 */
struct _HV_INPUT_MODIFY_VTL_PROTECTION_MASK
{
...
/* 3763 */
struct __declspec(align(8)) _HV_INPUT_RESET_DEBUG_SESSION
{
  unsigned int Options;
};
...
/* 4050 */
struct _HV_INPUT_GET_VP_REGISTERS
{
  unsigned __int64 PartitionId;
  unsigned int VpIndex;
  _HV_INPUT_VTL InputVtl;
...
/* 6284 */
struct _HV_GENERIC_SET
{
  unsigned __int64 Format;
  unsigned __int64 ValidBanksMask;
  unsigned __int64 BankContents[];
};

/* 6285 */
struct _HV_INPUT_FLUSH_VIRTUAL_ADDRESS_SPACE_HEADER_EX
{
  unsigned __int64 AddressSpace;
  unsigned __int64 Flags;
  _HV_GENERIC_SET ProcessorSet;
};

/* 6286 */
struct _HV_INPUT_FLUSH_VIRTUAL_ADDRESS_LIST_EX
{
  _HV_INPUT_FLUSH_VIRTUAL_ADDRESS_SPACE_HEADER_EX Header;
};
...
/* 6354 */
struct _HV_INPUT_FLUSH_VIRTUAL_ADDRESS_SPACE_EX
{
  _HV_INPUT_FLUSH_VIRTUAL_ADDRESS_SPACE_HEADER_EX Header;
};
...
/* 6367 */
struct _HV_INPUT_SEND_SYNTHETIC_CLUSTER_IPI_EX
{
  unsigned int Vector;
  _HV_INPUT_VTL TargetVtl;
  unsigned __int8 RsvdZ0;
...
/* 12425 */
typedef _HV_INPUT_ENABLE_PARTITION_VTL *PHV_INPUT_ENABLE_PARTITION_VTL;
...
/* 13843 */
typedef _HV_GENERIC_SET_FORMAT *PHV_GENERIC_SET_FORMAT;
...
/* 15586 */
typedef _HV_INPUT_FLUSH_VIRTUAL_ADDRESS_SPACE *PHV_INPUT_FLUSH_VIRTUAL_ADDRESS_SPACE;
...
/* 15629 */
typedef _HV_INPUT_RESET_DEBUG_SESSION *PHV_INPUT_RESET_DEBUG_SESSION;

/* 15642 */
typedef _HV_GENERIC_SET *PHV_VP_SET;
...
/* 16408 */
typedef unsigned int HV_DEBUG_OPTIONS;
...
/* 17916 */
typedef _HV_INPUT_FLUSH_VIRTUAL_ADDRESS_SPACE_HEADER *PHV_INPUT_FLUSH_VIRTUAL_ADDRESS_SPACE_HEADER;
...
/* 17946 */
typedef _HV_REGISTER_ASSOC *PHV_REGISTER_ASSOC;
...
/* 18043 */
typedef _HV_INPUT_SEND_SYNTHETIC_CLUSTER_IPI_EX *PHV_INPUT_SEND_SYNTHETIC_CLUSTER_IPI_EX;
...
/* 18162 */
typedef _HV_REGISTER_NAME *PHV_REGISTER_NAME;

/* 18165 */
typedef _HV_INPUT_ENABLE_VP_VTL *PHV_INPUT_ENABLE_VP_VTL;
...
/* 18257 */
typedef _HV_INPUT_SET_GPA_PAGE_ATTRIBUTES *PHV_INPUT_SET_GPA_PAGE_ATTRIBUTES;
...
/* 18348 */
typedef _HV_INPUT_FLUSH_VIRTUAL_ADDRESS_LIST *PHV_INPUT_FLUSH_VIRTUAL_ADDRESS_LIST;

/* 18376 */
typedef _HV_INPUT_VTL *PHV_INPUT_VTL;
...
/* 19363 */
typedef _HV_INPUT_FLUSH_VIRTUAL_ADDRESS_SPACE_EX *PHV_INPUT_FLUSH_VIRTUAL_ADDRESS_SPACE_EX;
...
/* 19934 */
typedef _HV_GENERIC_SET *PHV_GENERIC_SET;
...
/* 19988 */
typedef _HV_INPUT_RETRIEVE_DEBUG_DATA *PHV_INPUT_RETRIEVE_DEBUG_DATA;

/* 20042 */
typedef _HV_X64_PENDING_INTERRUPTION_TYPE *PHV_X64_PENDING_INTERRUPTION_TYPE;
...
/* 20514 */
typedef _HV_INPUT_FLUSH_VIRTUAL_ADDRESS_LIST_EX *PHV_INPUT_FLUSH_VIRTUAL_ADDRESS_LIST_EX;
...
/* 20784 */
typedef _HV_INPUT_MODIFY_VTL_PROTECTION_MASK *PHV_INPUT_MODIFY_VTL_PROTECTION_MASK;
...
/* 20840 */
typedef _HV_GPA_PAGE_ATTRIBUTES *PHV_GPA_PAGE_ATTRIBUTES;
...
/* 21400 */
typedef _HV_INPUT_GET_VP_REGISTERS *PHV_INPUT_GET_VP_REGISTERS;

/* 21449 */
typedef _HV_INPUT_FLUSH_VIRTUAL_ADDRESS_SPACE_HEADER_EX *PHV_INPUT_FLUSH_VIRTUAL_ADDRESS_SPACE_HEADER_EX;

/* 21479 */
typedef unsigned int *PHV_PROXIMITY_DOMAIN_ID;

/* 21521 */
typedef _HV_INPUT_SEND_SYNTHETIC_CLUSTER_IPI *PHV_INPUT_SEND_SYNTHETIC_CLUSTER_IPI;
...
/* 22389 */
typedef _HV_INPUT_SET_VP_REGISTERS *PHV_INPUT_SET_VP_REGISTERS;
